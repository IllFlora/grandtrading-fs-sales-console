...
- 納品説明Google Slides: https://docs.google.com/presentation/d/13IK-sL7T0y8amS0b2qyv3GXx-gFK9aaPoVybRVhO6TU/edit
...
6. `07_FS分析ボード` — 担当者・期間別KPI、ファネル、日次推移、業種、現在フェーズ
...
Web利用には、Google OAuthの許可対象、`03_設定` の有効なFSユーザー登録、対象Google Sheetsの編集権限の3点が必要です。FSはシートを直接操作しませんが、本人のGoogle権限でSheets APIへ書き込むため共有が必要です。マスターは `neosanepix@gmail.com` です。
